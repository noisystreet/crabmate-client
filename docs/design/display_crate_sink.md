...
> **单包 crates.io**：Server [`crates_io_single_package.md`](https://github.com/noisystreet/CrabMate/blob/main/docs/design/crates_io_single_package.md)（W3 **缓做**；钉 crates.io **`crabmate` `0.5.2`** + `protocol`）。
